This callback event returns information about a vector entity, selected using the mouse,  when the [RxCore.getVectorEntity](../methods/getVectorEntity.md) tool is used.
...
RxCore.GUI_2DEntityInfo.connect(function(vectorinfo, screenmouse, pathindex){
